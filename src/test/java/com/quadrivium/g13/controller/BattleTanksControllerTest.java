...
public class BattleTanksControllerTest {
    ...
    public void setUp() throws OutOfBoundsException, InvalidGameException {
        ...
        level.setActiveGame(bt);
    }

    @Test
    public void enemyCollide() throws OutOfBoundsException, IOException, InterruptedException, InvalidGameException {
        this.bt.setEnemyAtPlayerPosition();
        this.bt.setPlayerLives(1);
        assertEquals(this.bt.play(level), GameResult.LOSE);
